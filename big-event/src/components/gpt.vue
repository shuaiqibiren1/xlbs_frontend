          ...
          <div class="page-container">
            ...
            <div class="recent-posts">
              ...
              <div class="announcement background-opacity">
                ...
                <div>
                    文心一言大模型来进行问答功能并且可以根据选择的nii图像和医生评语以及各种心脏参数生成诊断报告单。
                </div>
              </div>
...
import Report from '@/components/common/HeartReport.vue'
